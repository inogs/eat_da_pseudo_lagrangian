...
class P1l(eatpy.filter.CvtHandler):
    ...
    def __init__(self, eofs_file: str = 'data/init/eof.txt', z_file: str = 'data/init/z.txt', name: str = 'OGS-3Dvar'):
        ...
        self.z_file=z_file
        #self.allvars = frozenset(('P1_Chl','P2_Chl','P3_Chl','P4_Chl'))
        #self.chlvars = frozenset(('P1_Chl','P2_Chl','P3_Chl','P4_Chl'))
    ...
    def initialize(self, variables: Mapping[str, Any], ensemble_size: int):
        ...
        #self.pvars = frozenset([variable for variable in variables.keys() if variable[0]=='P'])
        #self.chlvars = frozenset([variable for variable in self.pvars if variable[-3:-1]=='Chl'])
