...
PLUGINS=${PLUGINS}"-p eatpy.plugins.Select(include=('P?_*','total_chlorophyll_calculator_result')) "
#PLUGINS=${PLUGINS}"-p myPlugins.plugin_nit.NitDens() "

LOGVARS="'P1_c','P1_n','P1_p','P1_Chl','P1_s','P2_c','P2_n','P2_p','P2_Chl','P3_c','P3_n','P3_p','P3_Chl','P4_c','P4_n','P4_p','P4_Chl','total_chlorophyll_calculator_result'"
